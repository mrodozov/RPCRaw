...
public:
  ...
  map<int,vector<double> > getReconstructedHits(vector<int> vectorOfReferenceChambers,const int & timeWindow,const int & timeReference,bool & isVerticalTrack,const bool & keepRecoTrack,TFile * fileToWriteRecoTracks,const int & eventNum,const double &Chi2Goodnes = 1,const ESiteFileType & fileType = kIsCERNrawFile);

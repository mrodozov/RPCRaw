...
class A1_Mod {
 ...
 //Canvases
   ...
   TH1F *hTrigger;
   TH1F *hTOFDiff;
   A1_Mod( char * fName, unsigned ModulesCnt = 2);
   virtual ~A1_Mod();
   ...
   virtual void     PlotCoinc( unsigned aChannelFirst, unsigned aChannelSecond );
   virtual void     PlotAll( unsigned aModule);
};

#endif

#ifdef A1_Mod_cxx
A1_Mod::A1_Mod( char * fName, unsigned ModulesCnt )
{
  TTree *tree = 0;
...
Int_t A1_Mod::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t A1_Mod::LoadTree(Long64_t entry)
{
...
void A1_Mod::Show(Long64_t entry)
{
...
Int_t A1_Mod::Cut(Long64_t entry)
{

...
map<int,vector<double> > RPCChambersCluster::getReconstructedHits(vector<unsigned> vectorOfReferenceChambers, const int & timeWindow,const int & timeReference,bool & isVerticalTrack,const bool & keepRecoTrack,TFile * fileForRecoTracks,const int & eventNum,const double & Chi2goodness, const ESiteFileType & fileType){
